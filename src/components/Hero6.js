    ...
    return (
        <div className='relative flex flex-col md:flex-row w-full px-6 md:px-36 py-6 md:py-10 bg-[#F5FBFB] overflow-hidden gap-x-10' id='about'>
            <div className='flex md:flex-1 h-full justify-center items-center my-auto'>
                <img src={Order} alt='Online Perfume Store UAE' className='py-6 w-full md:w-11/12' />
            </div>
            <div className='flex md:flex-1 h-full flex-col my-auto items-center md:items-start gap-4'>
                <div className='md:max-w-lg flex flex-col gap-2 md:gap-4 text-left'>
                    ...
                    <p className={`${styles.subHeading}`}>Elevate your senses with NoorJes Imagine Perfume, a top Dubai perfume brand. Discover how our commitment to premium quality, eco-conscious choices, and globally inspired scents offers a new level of perfume in Dubai. Buy best perfume online UAE.</p>
